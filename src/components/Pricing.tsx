    ...
    <section className="py-32 bg-surface-container-lowest">
      <div className="px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="bg-white text-black p-8 font-headline border-b-8 border-primary">
          ...
          <button className="w-full bg-black text-white py-4 font-black uppercase hover:bg-primary hover:text-black transition-colors">
            SELECT PROTOCOL
          </button>
        </div>
        ...
        <div className="bg-white text-black p-8 font-headline border-b-8 border-tertiary">
          ...
          <button className="w-full bg-black text-white py-4 font-black uppercase hover:bg-tertiary hover:text-black transition-colors">
            CONTACT ARCHITECT
          </button>
        </div>
      </div>
